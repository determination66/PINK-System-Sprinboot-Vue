  ...
  <footer class="footer">
    <el-col :span="8">
      <div class="footer-content footer-left">
        <div class="copyright footer-title">Copyright © 2023 Pink</div>
      </div>
    </el-col>
    <el-col :span="8">
      <div class="footer-content footer-left">
        <div class="bold footer-title">Contract</div>
        <div class="middle">Wuhan University of Science and Technology</div>
        <div class="middle">202002156023@wust.edu.cn</div>
      </div>
    </el-col>
    <el-col :span="8">
