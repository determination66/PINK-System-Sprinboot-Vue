...
// 登录注册模块
const Premise = () => import("../views/premise/main.vue")
...
// 应聘系统主体模块
const ApplySystem = () => import("../views/apply-system/main.vue")
const ApplyMain = () => import("../views/apply-system/home")
const ApplyProfile = () => import("../views/apply-system/profile.vue")
const ApplyEdit = () => import("../views/apply-system/edit")
const ApplyPosition = () => import("../views/apply-system/position.vue")
const ApplyApplication = () => import("../views/apply-system/application")
const ApplyCompany = () => import("../views/apply-system/company.vue")
...
// const ApplyProcess=()=>import("../components/apply-system/applyinfo/Applyprocess.vue")

// HR招聘系统主体模块
const HireSystem = () => import("../views/hire-system/main")
const HireMain = () => import("../views/hire-system/home")
const HireAttract = () => import("../views/hire-system/attract.vue")
const HireRelease = () => import("../views/hire-system/release")
const HireProfile = () => import("../views/hire-system/profile.vue")
