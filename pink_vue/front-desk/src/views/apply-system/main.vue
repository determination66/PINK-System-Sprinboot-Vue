    ...
    <header class="header" style="z-index: 1">
      <nav-menu>
        ...
        <el-submenu index="7" style="float: right">
          ...
          <nav-pull-item path="/premise/apply_login">退出登录</nav-pull-item>
        </el-submenu>
      </nav-menu>
    </header>
...
<script>
// NavMenu组件
import NavMenu from "../../components/apply-system/navmenu/NavMenu.vue";
// NavMenuItem组件
import NavMenuItem from "../../components/apply-system/navmenu/NavMenuItem.vue";
// NavPullItem组件
import NavPullItem from "../../components/apply-system/navmenu/NavPullItem";
// NavBar组件
import NavBar from "../../components/apply-system/navbar/NavBar.vue";
// Footer组件
import FooterBar from "../../components/apply-system/footer/Footer.vue";
