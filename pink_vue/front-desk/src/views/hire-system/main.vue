<template>
  <el-row class="height-all all-bgc">
    <el-col :span="4" class="height-all">
      ...
      <router-link :to="{path:'/hire/hire_home'}" >
        <div class="logo-col">
        ...
        <div class="feature-col">
          <ul>
            ...
            <nav-menu-item v-for="item in navMenuItems" :key="item.index" :item="item"></nav-menu-item>
          </ul>
        </div>
      </div>
    </el-col>
...
<script>
// 导入NavMenuItem模块
import NavMenuItem from "../../components/hire-system/navmenu/NavMenuItem.vue";
// 导入AvatarItem模块
import AvatarItem from "../../components/hire-system/navmenu/AvatarItem.vue";
// 导入DrawerBox模块
