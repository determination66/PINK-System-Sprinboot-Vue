        ...
        <div class="right-content">
          ...
          <div class="form">
            <el-form ref="form" :model="form" label-width="80px">
              <div class="form-item">
                <el-input v-model="form.phone" placeholder="请输入账号" @keyup.enter.native="onSubmit()"></el-input>
              </div>
              <div class="form-item">
                <el-input v-model="form.password" placeholder="请输入密码" show-password @keyup.enter.native="onSubmit()"></el-input>
              </div>
              <div class="form-item">
          ...
          <div class="another-log">
            <!-- <span class="left-span">
              <el-button type="text" class="another-btn" @click="turnRegister">
                点击注册
              </el-button>
            </span> -->
