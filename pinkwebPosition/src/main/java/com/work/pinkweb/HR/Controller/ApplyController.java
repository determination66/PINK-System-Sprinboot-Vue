...
public class ApplyController {
    ...
    //通过user的id获取他的申请情况
    @RequestMapping("/index/apply_home/applyProcess/{u_id}")
    public List<Apply> getApplyByUid(@Param("u_id") @PathVariable Integer u_id){
        System.out.println("测试*************"+u_id);
        return applyService.getApplyByUid(u_id);
    }
